...
package net.dirtcraft.dirtcore.neoforge_1_21_1.command;
...
import net.dirtcraft.dirtcore.neoforge_1_21_1.platform.argument.NeoForgeArgumentFactory;
...
public class NeoForgeBrigadierExecutor extends BrigadierExecutor<CommandSourceStack> {
    ...
    public NeoForgeBrigadierExecutor(final DirtCoreNeoForgePlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void onRegisterCommands(final RegisterCommandsEvent event) {
        ...
        this.plugin.buildCommands(
                new NeoForgeArgumentFactory(this.plugin, event.getBuildContext()));
